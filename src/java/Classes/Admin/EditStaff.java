...
public class EditStaff extends HttpServlet {
 ...
 /*+ "      <center><h2>UPDATE STAFF RECORD</h2></center>"
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                        <div class=\"card-body\">\n"
                        + "                            <h3 class=\"card-title\"><center><h2><b>ADD STAFF RECORD</b></h2></center></h3>\n"
                        + "                            <br><br>\n"
                        + "                            <!-- General Form Elements -->\n"
                        + "                            <form action='SaveEditedStaff' method=\"POST\">\n"
                        + "                                <div class=\"row mb-3\">\n"
                        + "                                    <label for=\"userid\" class=\"col-sm-2 col-form-label\"><b>USER ID</b></label>\n"
                        + "                                    <div class=\"col-sm-10\">\n"
                        ...
                        + "\n"
                        + "                                    <div class=\"col-sm-10\">\n"
                        + "                                        <button type=\"submit\" class=\"btn btn-dark\" style=\"background-color:  #ff0800\" >UPDATE</button>\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
